...
#            print 'music on'
    def setMusicVolume(self):
        ...
        self.world.audioManager.setMusicVolume(self.musicVolume)
...
#                                       scrollSize = 1,
    ...
    def setSoundScale(self):
        ...
        self.world.audioManager.setSoundVolume(self.soundScale)
...
#                                       scrollSize = 1,
    ...
    def exitGameRequest(self):
        ...
        if not self.exitGameMessageIsShown:
            ...
            main.createMessageBox(1, "Are you sure you want to quit the game?", self.exitGame)

    
    def exitGame(self, _exit=None):
        """
