...
from main.MainLobby.WorldLobby.PvPWorldLobby import PvPWorldLobby, WorldObj
...
class Main(DirectObject):
    ...
    def __init__(self):
        ...
        self.accept('control-f', self.setFullScreenMode)
        self.accept('escape', self.exitFullScreenMode)
    ...
    def showAlert(self, status):
        ...
        main.createMessageBox(0, result['msg_text'], '', [])
