...
#                                               boxPlacement='right',
    ...
    def createSoundOptions(self):
        ...
        self.soundOptions = [DirectRadioButton(text = 'On', 
                                               text_scale=0.05,
                                               text_fg=(0,0,0,1),
                                               variable=self.soundOn, 
                                               value=[1], 
                                               scale=0.05,
                                               indicatorValue=1, 
#                                               frameSize=(-0.1,0.1, -0.05,0.05),
...
#                                               boxPlacement='right',
                                               ...
                                               boxBorder=0,
                                               command=self.setSoundOnOff)]
        self.soundOptions[0].reparentTo(self.menuFrame)
        self.soundOptions[1].reparentTo(self.menuFrame)
        for button in self.soundOptions:        
            button.setOthers(self.soundOptions)

    def setSoundOnOff(self):
        if self.soundOn[0] == 0:
            print 'sound off'
        else:
            print 'sound on' 
