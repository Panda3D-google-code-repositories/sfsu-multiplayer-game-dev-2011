...
#    BG_COLOR = (0.18, 0.18, 0.31, 0.95)
    ...
    CMSG_CHANGE_TEAM_PVP                = 61

    CMSG_UPDATE_ANIMAL_TARGET           = 101
    CMSG_UPDATE_ANIMAL_COORS            = 103

    CMSG_UPDATE_PLANT_COORS             = 107

    CMSG_START_SIXTY_SECONDS_COUNTER    = 109
    ...
    CMSG_REQUESTWATERSOURCES            = 211

    CMSG_GETPVEWORLDS_CLOSED            = 213
    CMSG_GETPVEWORLDS_OPEN              = 215
    
    CMSG_REQUEST_GET_ENVIRONMENT        = 217
    ...
    SMSG_CHANGE_AVATAR_TYPE             = 20

    SMSG_PASSWORD_PRIVATE_WORLD         = 22
    SMSG_START_GAME                     = 24
    SMSG_CHAT                           = 26
    SMSG_UPDATE_ANIMAL_NO_WATER_COUNT   = 28
    SMSG_KILL_ANIMAL                    = 30
    SMSG_CURE_ANIMAL_DISEASE            = 32
    SMSG_CURE_PLANT_DISEASE             = 34
    ...
    SMSG_CHANGE_TEAM_PVP                = 62
    SMSG_BIRTH_ANIMAL                   = 64
    SMSG_REVEAL_ANIMAL_DISEASE          = 66
    SMSG_CURE_ANIMAL_DISEASE            = 68
    SMSG_UPDATE_ANIMAL_BIOMASS          = 70
    SMSG_UPDATE_PLANT_BIOMASS           = 72
    SMSG_BIRTH_PLANT                    = 74
    SMSG_UPDATE_PLANT_NO_WATER_COUNT    = 76
    SMSG_UPDATE_ANIMAL_ZONE             = 78
    SMSG_UPDATE_ANIMAL_OWNER            = 80
    SMSG_UPDATE_PLANT_NO_LIGHT_COUNT    = 82
    SMSG_KILL_PLANT                     = 84
    SMSG_UPDATE_WATER_SOURCE            = 86
    SMSG_CURRENT_DAY                    = 88
    SMSG_WEATHER_PREDICTION             = 90
    SMSG_UPDATE_AVG_GAME_SCALE          = 92
    SMSG_UPDATE_AVATAR_XP               = 94
    SMSG_UPDATE_AVATAR_CASH             = 96
    SMSG_UPDATE_ENV_SCORE               = 98
    SMSG_SET_USER_PRIMARY_AVATAR        = 100

    SMSG_UPDATE_ANIMAL_TARGET           = 102
    SMSG_UPDATE_ANIMAL_COORS            = 104
    SMSG_REVEAL_PLANT_DISEASE           = 106
    SMSG_UPDATE_PLANT_COORS             = 108
    SMSG_START_SIXTY_SECONDS_COUNTER    = 110
    ...
    SMSG_REQUESTWATERSOURCES            = 212
    
    SMSG_GETPVEWORLDS_CLOSED            = 214
    SMSG_GETPVEWORLDS_OPEN              = 216

    SMSG_RESPONSE_GET_ENVIRONMENT        = 218
