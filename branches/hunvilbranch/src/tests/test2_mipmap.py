...
class World(DirectObject):
    def __init__(self):
        ...
        self.terrain.setHeightfield("./models/height129.png")
        self.wterrain.setHeightfield("./models/height129_river.png")
        tex = loader.loadTexture("./models/sav.jpg")
        ...
        wroot.setEffect(CompassEffect.make(render))
