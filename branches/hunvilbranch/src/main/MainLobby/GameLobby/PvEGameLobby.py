...
class PvEGameLobby:
    ...
    def __init__(self, parent):
        ...
        main.msgQ.addToCommandList(Constants.CMSG_GETPVEWORLDS_CLOSED, self.loadClosedWorldList)
        main.msgQ.addToCommandList(Constants.CMSG_GETPVEWORLDS_OPEN, self.loadOpenedWorldList)
...
#        if isClosed == 0:
#            worldName = self.closedWorldLog[self.topIndexOfList[0] + index].gameName
#            obj={"worldName": worldName, "password": ""}
...
#        else:
#            obj={"worldName": self.openedWorldLog[self.topIndexOfList[1] + index].gameName, "password": ""}
#            main.cManager.sendRequest(Constants.CMSG_JOIN_PVE_WORLD, obj)
    ...
    def unload(self):
        main.msgQ.removeEvent(Constants.CMSG_GETPVEWORLDS_CLOSED)
        main.msgQ.removeEvent(Constants.CMSG_GETPVEWORLDS_OPEN)
