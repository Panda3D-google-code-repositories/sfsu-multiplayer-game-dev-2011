...
#        self.control.disable()
    ...
    def loadAnimalItems(self):
        imageDirectory = "models/gameshop/animal/"
        _animalType = ["animal1",
                       "animal2",
                       "animal3",
                       "animal4",
        ...
        _images=[imageDirectory+'Aardvark_79.jpg',
                 imageDirectory+'African clawless otter_70.jpg',
                 imageDirectory+'African fish eagle_53.jpg',
                 imageDirectory+'Bat eared fox_59.jpg',
                 imageDirectory+'Black mamba_75.jpg',
                 imageDirectory+'Bohor reedbuck_82.jpg',
                 imageDirectory+'flies_13.jpg',
                 imageDirectory+'crab_35.jpg']
        ...
        _predator_list=['', '', '', '','','','','']
        for i in range(8):
            self.animals.append({self.key_type: _animalType[i],
    ...
    def loadPlantItems(self):
        ...
        for i in range(8):
            self.plants.append({self.key_type : _plantType[i],
                                self.key_cost: _costs[i], 
                            self.key_image: _images[i], 
                            self.key_prey_list: _prey_list[i],
                            self.key_predator_list:_predator_list[i],
...
#                                          onMouseOverExtraArgs=[i],
    ...
    def loadImages(self):
        ...
        for i in range(4):
            ...
            self.items[i]['extraArgs']=[self.images[self.currentLefeMost+i][self.key_type]]
...
#        self.control.disable()
    ...
    def buyItem(self, _type):
        if Constants.DEBUG:
            print 'Buy Item: '+_type
        self.world.gameState.requestBuyAnimal(_type)
