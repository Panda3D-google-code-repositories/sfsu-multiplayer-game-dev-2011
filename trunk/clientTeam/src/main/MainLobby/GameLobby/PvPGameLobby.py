...
from main.MainLobby.GameLobby.NewPvPWorldWindow import NewPvPWorldWindow
...
class PvPGameLobby:
    ...
    def __init__(self, parent):
        ...
        self.newGameWindow = NewPvPWorldWindow(self.mainFrame)
...
class GameObject:
    ...
    def __init__(self, gameName, players, maxPlayers, ecosystem, isReturned=1):
