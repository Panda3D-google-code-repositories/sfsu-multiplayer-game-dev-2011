...
#        self.createLabels()
        ...
        main.msgQ.addToCommandList(Constants.CMSG_SEEONLINEPLAYERS, self.receiveMessage)
        self.hide()
...
#            self.world.charHero.chatBubble.clear()
    ...
    def hide(self):
#        main.msgQ.removeEvent(Constants.CMSG)
...
#        self.onlinePlayerLabel.hide()
    ...
    def show(self):
        main.msgQ.addToCommandList(Constants.CMSG_CHAT, self.chat.addMessage)
