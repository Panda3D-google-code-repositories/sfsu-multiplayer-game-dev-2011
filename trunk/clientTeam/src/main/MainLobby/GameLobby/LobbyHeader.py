...
class LobbyHeader:
    ...
    def __init__(self):
        ...
        #self.createButtonsPressedImages()    #HJR
        self.currentMode = 0
        ...
        self.lobby.show()
        taskMgr.doMethodLater(0, main.updateRoutine, 'updateRoutine-Main')
...
#                                             command=self.switchToPvPWorldLobby)
    ...
    def responseFromServer(self, obj):
        """
        This response search private world
        """
