...
class Register:
    ...
    def __init__(self):
        ...
        main.msgQ.addToCommandList(Constants.CMSG_REGISTER, self.responseRegister)
    ...
    def submitText(self, text=None):
        ...
        if self.registerEntry[0].get() == '':
            ...
            self.setFocus(4)
        elif self.registerEntry[1].get() != self.registerEntry[2].get():
    ...
    def responseRegister(self, status):
