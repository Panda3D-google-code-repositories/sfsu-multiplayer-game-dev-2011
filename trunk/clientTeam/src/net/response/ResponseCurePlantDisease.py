...
class ResponseCurePlantDisease(ServerResponse):
    ...
    def execute(self, data):
        ...
        try:
            ...
            self.log('Received [' + str(Constants.SMSG_CURE_PLANT_DISEASE) + '] Cure Plant Disease Response')

        except:
            self.log('Bad [' + str(Constants.SMSG_CURE_PLANT_DISEASE) + '] Cure Plant Disease Response')
            print_exc()
