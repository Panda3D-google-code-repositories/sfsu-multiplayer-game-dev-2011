...
class ResponseStartToReadyWorld(ServerResponse):
    ...
    def execute(self, data):
        ...
        try:
            ...
            self.log('Received [' + str(Constants.SMSG_START_TO_READY_GAME) + '] Start To Ready Game Response')

        except:
            self.log('Bad [' + str(Constants.SMSG_START_TO_READY_GAME) + '] Start To Ready Game Response')
            print_exc()