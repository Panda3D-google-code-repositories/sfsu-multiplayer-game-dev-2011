...
class DatabaseHelper:
    ...
    db = SeriousGames()
    @staticmethod
    def dbSelectRowByIDAnimal(table, attribute, value):
        ...
        if type(value) is str:
            query = 'SELECT name FROM ' + table + ' WHERE ' + attribute + ' = \'' + value + '\''
        else:
            query = 'SELECT name FROM ' + table + ' WHERE ' + attribute + ' = ' + str(value)
