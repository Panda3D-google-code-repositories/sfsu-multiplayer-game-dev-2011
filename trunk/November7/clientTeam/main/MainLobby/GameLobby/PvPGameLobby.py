...
class PvPGameLobbyControl(DirectObject):

    def __init__(self, parent=None):
        self.accept(Constants.UPDATE_PVP_ONLINE_PLAYERS, parent.receiveMessage, [])
        self.accept(Constants.LISTENER_PVP_ONLINE_PLAYERS, parent.loadGameList, [])
...
class PvPGameLobby:
    ...
    def __init__(self, parent):
        ...
        self.control = PvPGameLobbyControl(self)
        self.loadGameList()
        self.hide()
...
#            self.scrollBar1['value'] = round(self.scrollBar1['value']) - 1
    ...
    def switchToPvPWorldLobby(self, index):
        print "join button no." + str(index) + " click"
        print "player: " + self.gameLog[self.topIndexOfList + index].gameName
...
#            self.listIsLoaded = True
        ...
        print 'request list of game from server'
...
class GameObject:
    ...
    def __init__(self, gameName, players, maxPlayers, ecosystem):
