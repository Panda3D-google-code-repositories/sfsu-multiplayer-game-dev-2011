...
public class Avatar {
    ...
    public int getGameScaleVote() {
        return gamescale_vote;
    }

    public boolean setGameScaleVote(int gameScaleVote) {
        if (gameScaleVote > 0 && gameScaleVote <= 10) {
            gamescale_vote = gameScaleVote;
            return true;
        }
