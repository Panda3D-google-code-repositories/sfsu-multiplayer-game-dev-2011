...
public abstract class Organism {
    ...
    public int setSpeciesTypeID(int species_type_id) {
        if (organism_type == Constants.ORGANISM_TYPE_PLANT) {
            speciesType = GameServer.getInstance().getPlantType(species_type_id);
        } else if (organism_type == Constants.ORGANISM_TYPE_ANIMAL) {
            speciesType = GameServer.getInstance().getAnimalType(species_type_id);
        }
    ...
    public int setGroupSize(int count) {
